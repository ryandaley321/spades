...
export const metadata: Metadata = {
  title: "Privacy Policy | Spades Poker House Webster & Baytown TX",
  description: "Privacy Policy for Spades Poker House. Learn how we collect, use, and protect your personal information at our Webster and Baytown poker locations.",
  keywords: "Spades Poker House privacy policy, Texas poker privacy, Webster Baytown poker data protection, privacy information",
  robots: "index, follow",
  alternates: {
    canonical: "https://spades-gamma.vercel.app/privacy-policy",
  },
  other: {
    "geo.region": "US-TX",
  },
        ...
        <div className="px-4 py-12 md:py-20">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center mb-8" style={{ color: '#F7E7CE', fontFamily: 'Poppins', fontWeight: 600, fontSize: '18px', lineHeight: '100%', letterSpacing: '0%' }}>
              This privacy statement was last updated on March 3rd, 2025, and applies to all site visitors.
            </p>
