    ...
    <div className="min-h-screen bg-black text-white">
      <style
        dangerouslySetInnerHTML={{
          ...
          .spade-line.bottom.visible { transform: scaleY(1); }
        `,
        }}
      />
      ...
      <section className="relative" style={{ backgroundColor: '#181510' }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <GoogleReviewCard name="Michael Torres" rating={5} comment="Great Atmosphere, friendly staff and surprisingly great food for a Poker place!" isLocalGuide={true} reviewCount={47} photoCount={12} />
            <GoogleReviewCard name="David Chen" rating={5} comment="Virtually always great service from service team, dealers, and management." isLocalGuide={true} reviewCount={31} photoCount={8} />
            <GoogleReviewCard name="Sarah Johnson" rating={5} comment="Best poker room in Houston area! Professional dealers, clean facility, and the action never stops. Highly recommend!" reviewCount={92} photoCount={5} />
            <GoogleReviewCard name="James Rodriguez" rating={5} comment="Love the atmosphere here! Great promotions, friendly staff, and the food is actually really good. My go-to poker spot!" reviewCount={156} photoCount={23} />
          </div>
